...
UCM_ASU_AICPU_USE_STAGED_CHANNEL_API="${UCM_ASU_AICPU_USE_STAGED_CHANNEL_API:-ON}"
BUILD_UCM_ASU_PROVIDER_FAKE="${BUILD_UCM_ASU_PROVIDER_FAKE:-ON}"
BUILD_UCM_ASU_PROVIDER_AIV="${BUILD_UCM_ASU_PROVIDER_AIV:-OFF}"
ASCEND_SUPPORTS_REGISTER_PIN="${ASCEND_SUPPORTS_REGISTER_PIN:-OFF}"
...
cmake -S "${PROJECT_ROOT}" -B "${BUILD_DIR}" \
    ...
    -DASCEND_SUPPORTS_REGISTER_PIN="${ASCEND_SUPPORTS_REGISTER_PIN}" \
    -DBUILD_UCM_ASU_PROVIDER_AICPU="${BUILD_UCM_ASU_PROVIDER_AICPU}" \
    -DUCM_ASU_AICPU_USE_STAGED_CHANNEL_API="${UCM_ASU_AICPU_USE_STAGED_CHANNEL_API}" \
